...
export const UserProvider = ({children}) => {
    ...
    const {
        userUploadPost,userFetchAllPosts,userUploadProfilePhoto,
      userFetchCurrentPosts,userFetchSavedPosts, userDeletePost} = useFileStore()
    ...
    const handleChangePhoto = async (e) =>{
        ...
        try{await userUploadProfilePhoto(selectedFile)
        }catch (error){
            console.log(error)
        }
    }
